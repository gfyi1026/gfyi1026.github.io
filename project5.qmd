...
Now, I can use the output of the above query in my plot below:
```{r}
#| label: fig-citation-rates-race
#| fig-alt: "Side-by-side bar chart comparing citation rates across racial groups in Long Beach, Mesa, and San Jose between 2014 and 2016, where the x-axis the subject race and the y-axis is the citation rate, and each city has its own bar per subject race. Long Beach and Mesa show consistently high citation rates across groups, while San Jose shows much lower citation rates for all races."
